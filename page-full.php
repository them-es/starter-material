...
?>
	...
	<div id="post-<?php the_ID(); ?>" <?php if ( isset($class) && $class != "" ) : post_class('mdl-cell mdl-cell--12-col ' . $class); else: echo post_class('mdl-cell mdl-cell--12-col'); endif; ?><?php if ( isset($style) && $style != "" ) : echo ' style="' . $style . '"'; endif; ?>>
