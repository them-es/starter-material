...
function themes_starter_scripts_loader() {
	...
	wp_enqueue_style( 'main', get_template_directory_uri() . '/assets/dist/main.css', false, $theme_version, 'all' ); // main.scss: Compiled Framework source + custom styles

	if ( is_rtl() ) {
		wp_enqueue_style( 'rtl', get_template_directory_uri() . '/assets/dist/rtl.css', false, $theme_version, 'all' );
	}

	// 2. Scripts
	wp_enqueue_script( 'mainjs', get_template_directory_uri() . '/assets/dist/main.bundle.js', false, $theme_version, true );
